# -*- coding: utf-8 -*-
"""testing_on_dataset2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1j9o5UYYGMvc-U3vlRNj158d5oiub2DL4
"""
...
import zipfile
zip_path = './Test_dataset2.zip'  # Path to the downloaded dataset zip file
...
directory_path = "./Test_dataset2/1_shot_dataset/night1"

# Create a CSV file to store the paths and class labels
csv_file = "Query_samples_shot_1.csv"
...
# Set the directory path where the subfolders and images are located
directory_path = "./Test_dataset2/2_shot_dataset/night2"

# Create a CSV file to store the paths and class labels
csv_file = "Query_samples_shot_2.csv"
...
# Set the directory path where the subfolders and images are located
directory_path = "./Test_dataset2/3_shot_dataset/night3"

# Create a CSV file to store the paths and class labels
csv_file = "Query_samples_shot_3.csv"
...
# Set the directory path where the subfolders and images are located
directory_path = "./Test_dataset2/4_shot_dataset/night4"

# Create a CSV file to store the paths and class labels
csv_file = "Query_samples_shot_4.csv"
...
# Set the directory path where the subfolders and images are located
directory_path = "./Test_dataset2/5_shot_dataset/night5"
...
from skimage import exposure
from multiprocessing import Pool
def Testdataset2_in_one_shot(threshold, Qcsv, supportpdroot):
...
def preprocessff(image):
      ...
      clahe_np = exposure.equalize_adapthist(image_np[0], clip_limit=0.03)
      image_clahe = Image.fromarray((clahe_np * 255).astype(np.uint8))

      return  image_clahe

def Testdataset2_in_few_shot(shot,threshold, Qcsv, supportpdroot):
    transform = transforms.Compose([
        transforms.Resize((100, 100)),
        transforms.ToTensor()
    ])
...
net.load_state_dict(torch.load('_model_.pth',map_location=torch.device('cpu')))

for i in range(0,5):
  accu,arar=Testdataset2_in_one_shot(.98,"./Query_samples_shot_1.csv", './Test_dataset2/1_shot_dataset/trainfaces')
  f1_csv("Dataset2_one_shot_result.txt",arar,accu*100,0.98,1,"Night_vision_dristibution")

for i in range(0,5):
  accu,arar=Testdataset2_in_few_shot(2,.98,"./Query_samples_shot_2.csv", './Test_dataset2/2_shot_dataset/trainfaces')
  f1_csv("Dataset2_two_shot_result.txt",arar,accu*100,0.98,2,"Night_vision_dristibution")

for i in range(0,5):
  accu,arar=Testdataset2_in_few_shot(3,.98,"./Query_samples_shot_3.csv", './Test_dataset2/3_shot_dataset/trainfaces')
  f1_csv("Dataset2_three_shot_result.txt",arar,accu*100,0.98,3,"Night_vision_dristibution")

for i in range(0,5):
  accu,arar=Testdataset2_in_few_shot(4,.98,"./Query_samples_shot_4.csv", './Test_dataset2/4_shot_dataset/trainfaces')
  f1_csv("Dataset2_four_shot_result.txt",arar,accu*100,0.98,4,"Night_vision_dristibution")

for i in range(0,5):
  accu,arar=Testdataset2_in_few_shot(5,.98,"./Query_samples_shot_5.csv", './Test_dataset2/5_shot_dataset/trainfaces')
  f1_csv("Dataset2_five_shot_result.txt",arar,accu*100,0.98,5,"Night_vision_dristibution")